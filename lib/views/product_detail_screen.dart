...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
                                ...
                                InkWell(
                                  onTap: () {
                                    if (trustedbadge == "1") {
                                                                        ...
                                                                        setState(
                                                                          ...
                                                                          if (negotiable ==
                                                                            ...
                                                                            days == "null" || days == "" || days == null
                                                                                ? totalrent = 0
                                                                                : totalrent = double.parse(productQty) * double.parse(days) * double.parse(productamount);
                                                                            totalsecurity =
                                                                                double.parse(productQty) * double.parse(securitydeposit);
                                                                            days == "null" || days == "" || days == null
                                                                                ? finalamount = totalsecurity + totalrent
                                                                                : finalamount = totalrent + totalsecurity;
                                                                          } else {
                                                                            setState(() {
                                                                            ...
                                                                            int useramountg = useramount == null
                                                                                ? 1
                                                                                : int.parse(useramount.toString());
                                                                            int daysg = days == null
                                                                                ? 1
                                                                                : int.parse(days.toString());
                                                                        ...
                                                                        if (negotiable ==
                                                                          ...
                                                                          setState(
                                                                            ...
                                                                            days == null
                                                                                ...
                                                                                : totalrent = double.parse(productQty) * double.parse(days) * double.parse(productamount);
                                                                            totalsecurity =
                                                                                double.parse(productQty) * int.parse(securitydeposit);
                                                                            days == "null" || days == "" || days == null
                                                                                ? finalamount = totalsecurity + totalrent
                                                                                : finalamount = totalrent + totalsecurity;
                                                                          });
                                      ...
                                      setState(() {
                                        productQty =
                                            getOfferData['quantity'].toString();
                                                                  ...
                                                                  negotiable ==
                                                                      ...
                                                                      ? TextFormField(
                                                                          ...
                                                                          decoration:
                                                                              InputDecoration(
                                                                            hintText:
                                                                                _getrenttypeamounthint(getOfferData['rent_type_name'].toString()),
                                                                            border:
                                                                                null,
                                                                          ),
                                                                          onChanged:
  ...
  Future _getproductDetail(String productid) async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        productimage =
            "${data['Images'][0]['upload_base_path'].toString() + data['Images'][0]['file_name'].toString()}";
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        for (int i = 0; i < data['posted_ad']['prices'].length; i++) {
          renttypelist
              .add(data['posted_ad']['prices'][i]['rent_type_name'].toString());
        }
      });
    } else {
      throw Exception('Failed to get data due to ${response.body}');
