...
class UserfinderDataScreen extends StatefulWidget {
  String getlocation;
  String getcategory;
  UserfinderDataScreen({this.getlocation, this.getcategory});

  @override
  _UserfinderDataScreenState createState() => _UserfinderDataScreenState(getlocation, getcategory);
}
      ...
      appBar: AppBar(
       ...
       body: Column(
         children: [
                       ...
                       child: TextField(
                         ...
                         onChanged: (String text) {
                           setState(() {
                              ...
                              if (title.toLowerCase().trim().contains(text.toLowerCase().trim())) {
           ...
           Expanded(
               child: _productdata.isEmpty || _productdata.length == 0 ? Center(
                                 ...
                                 child: Column(
                                   children: [
                                     CachedNetworkImage(
                                       ...
                                       fit: BoxFit.cover,
                                       imageUrl: "${bannerpath+_searchlist[index]['upload_base_path'].toString()+_searchlist[index]['file_name'].toString()}",
                                     ),
                                     SizedBox(height: 5.0),
                                     Padding(
                                       ...
                                       child: Align(
                                         ...
                                         child: Text(_searchlist[index]['title'].toString(), maxLines: 2, style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 16)),
                                       ),
                                     ),
                                     SizedBox(height: 5.0),
                                     Padding(
                                       ...
                                       child: Row(
                                         ...
                                         children: [
                                           SizedBox(
                                             ...
                                             child: Text("Starting from ${_searchlist[index]['currency'].toString()} ${_searchlist[index]['price'].toString()}", style: TextStyle(color: kPrimaryColor, fontSize: 12)),
                                           ),
                                           IconButton(onPressed: (){}, icon: Icon(Icons.add_box_rounded, color: kPrimaryColor))
                                         ],
                                       ),
                                     )
                                   ],
