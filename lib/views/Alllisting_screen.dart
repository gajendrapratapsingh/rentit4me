  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("All Listings", style: TextStyle(color: kPrimaryColor)),
        centerTitle: true,
      ),
                              ...
                              Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        startdate == null ? SizedBox() : Text(startdate, style: const TextStyle(color: Colors.grey)),
                              ...
                              Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        enddate == null ? const SizedBox() : Text(enddate, style: TextStyle(color: Colors.grey)),
                                        IconButton(onPressed: (){
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(sliderpath+ alllist[index]['upload_base_path'].toString() + alllist[index]['file_name'].toString(), fit: BoxFit.fill),
                                    ),
                                  ),
                                  SizedBox(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          alllist[index]['offers'].length == 0
                                              ? Text(alllist[index]['offers'].length.toString(), style: const TextStyle(color: Colors.black))
                                              : Text(alllist[index]['offers'].length.toString(), textAlign: TextAlign.center, style: const TextStyle(color: Colors.black))
                                        ]),
                                  ),
                                ]),
                            const SizedBox(height: 10.0),
