  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("All Listings", style: TextStyle(color: kPrimaryColor)),
        centerTitle: true,
      ),
                        ...
                        child: Padding(
                          ...
                          child: Column(children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network("https://dev.techstreet.in/rentit4me/public/" + alllist[index]['upload_base_path'].toString() + alllist[index]['file_name'].toString(), fit: BoxFit.fill),
                                    ),
                                  ),
                                  SizedBox(
                            ...
                            Row(
                                ...
                                children: [
                                  Column(children: [
                                       Text("Boost Status", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                                       SizedBox(height: 4.0),
                                       alllist[index]['boost_package_status'].toString() == "1" ? Container(
                                           ...
                                           child: Text("Boosted", style: TextStyle(color: Colors.white)),
                                         ) : Container(
                                            height: 25,
                                            width: 65,
                                            decoration: BoxDecoration(
                                  ...
                                  Column(children: [
                                      Text("Created At", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
